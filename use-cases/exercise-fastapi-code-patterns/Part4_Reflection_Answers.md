...
## Reflection Question 2: Which design patterns did you find most useful in the original code?
 Found the **Repository Pattern** combined with **Dependency Injection** (`Depends`) most useful. It cleanly isolated data storage operations from route controllers, making audit logging seamless to insert into login and admin endpoints.
